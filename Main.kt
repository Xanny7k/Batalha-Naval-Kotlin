...
fun coordenadaContida(tabuleiro: Array<Array<Char?>>, linha: Int, coluna: Int): Boolean{
    ...
    if(linha in  intervalo1 && coluna in intervalo2){
        return true
    }else return false
}
...
fun gerarCoordenadasFronteira(tabuleiro: Array<Array<Char?>>, linha: Int, coluna: Int, orientacao: String, dimensao: Int): Array<Pair<Int,Int>>{
    ...
    when (dimensao) {
        ...
        2->{
            when (orientacao){
                "N" ->{coordenadas = juntarCoordenadas(coordenadas, arrayOf(Pair(linha - 2, coluna-1), Pair(linha - 2, coluna), Pair(linha - 2, coluna + 1),
                        Pair(linha-1, coluna-1), Pair(linha-1, coluna + 1), Pair(linha, coluna-1), Pair(linha, coluna+1), Pair(linha + 1, coluna - 1), Pair(linha + 1, coluna), Pair(linha + 1, coluna + 1)))}
                "S"->{coordenadas = juntarCoordenadas(coordenadas, arrayOf(Pair(linha + 2, coluna-1), Pair(linha + 2, coluna), Pair(linha + 2, coluna + 1),
                        Pair(linha + 1, coluna-1), Pair(linha + 1, coluna + 1), Pair(linha, coluna-1), Pair(linha, coluna+1), Pair(linha - 1, coluna - 1), Pair(linha - 1, coluna), Pair(linha - 1, coluna + 1)))}
                "E"->{coordenadas = juntarCoordenadas(coordenadas, arrayOf(Pair(linha - 1, coluna-1), Pair(linha - 1, coluna), Pair(linha - 1, coluna + 1),
                        Pair(linha - 1, coluna + 2), Pair(linha, coluna-1), Pair(linha, coluna + 2), Pair(linha + 1, coluna-1), Pair(linha + 1, coluna), Pair(linha + 1, coluna + 1), Pair(linha + 1, coluna + 2)))}
                "O"->{coordenadas = juntarCoordenadas(coordenadas, arrayOf(Pair(linha - 1, coluna+1), Pair(linha - 1, coluna), Pair(linha - 1, coluna - 1),
                        Pair(linha - 1, coluna - 2), Pair(linha, coluna+1), Pair(linha, coluna - 2), Pair(linha + 1, coluna+1), Pair(linha + 1, coluna), Pair(linha + 1, coluna - 1), Pair(linha + 1, coluna - 2)))}
            }
        }
        3->{
            when (orientacao){
                "N" ->{coordenadas = juntarCoordenadas(coordenadas, arrayOf(Pair(linha - 3, coluna-1), Pair(linha - 3, coluna), Pair(linha - 3, coluna + 1),
                        Pair(linha - 2, coluna-1), Pair(linha - 2, coluna + 1), Pair(linha-1, coluna-1), Pair(linha-1, coluna + 1), Pair(linha, coluna-1),
                        Pair(linha, coluna+1), Pair(linha + 1, coluna - 1), Pair(linha + 1, coluna), Pair(linha + 1, coluna + 1)))}
                "S"->{coordenadas = juntarCoordenadas(coordenadas, arrayOf(Pair(linha + 3, coluna-1), Pair(linha + 3, coluna), Pair(linha + 3, coluna + 1),
                        Pair(linha + 2, coluna-1), Pair(linha + 2, coluna + 1), Pair(linha + 1, coluna-1), Pair(linha + 1, coluna + 1), Pair(linha, coluna-1),
                        Pair(linha, coluna+1), Pair(linha - 1, coluna - 1), Pair(linha - 1, coluna), Pair(linha - 1, coluna + 1)))}
                "E"->{coordenadas = juntarCoordenadas(coordenadas, arrayOf(Pair(linha - 1, coluna-1), Pair(linha - 1, coluna), Pair(linha - 1, coluna + 1),
                        Pair(linha - 1, coluna + 2), Pair(linha - 1, coluna + 3), Pair(linha, coluna-1), Pair(linha, coluna + 3), Pair(linha + 1, coluna-1),
                        Pair(linha + 1, coluna), Pair(linha + 1, coluna + 1), Pair(linha + 1, coluna + 2), Pair(linha + 1, coluna + 3)))}
                "O"->{coordenadas = juntarCoordenadas(coordenadas, arrayOf(Pair(linha - 1, coluna+1), Pair(linha - 1, coluna), Pair(linha - 1, coluna - 1),
                        Pair(linha - 1, coluna - 2), Pair(linha - 1, coluna - 3), Pair(linha, coluna+1), Pair(linha, coluna - 3), Pair(linha + 1, coluna+1),
                        Pair(linha + 1, coluna), Pair(linha + 1, coluna - 1), Pair(linha + 1, coluna - 2), Pair(linha + 1, coluna - 3)))}
            }
        ...
        4->{
            when (orientacao){
                "N" ->{coordenadas = juntarCoordenadas(coordenadas, arrayOf(Pair(linha - 4, coluna-1), Pair(linha - 4, coluna), Pair(linha - 4, coluna + 1),
                        Pair(linha - 3, coluna-1), Pair(linha - 3, coluna + 1), Pair(linha - 2, coluna-1), Pair(linha - 2, coluna + 1), Pair(linha-1, coluna-1),
                        Pair(linha-1, coluna + 1), Pair(linha, coluna-1), Pair(linha, coluna+1), Pair(linha + 1, coluna - 1), Pair(linha + 1, coluna), Pair(linha + 1, coluna + 1)))}
                "S"->{coordenadas = juntarCoordenadas(coordenadas, arrayOf(Pair(linha + 4, coluna-1), Pair(linha + 4, coluna), Pair(linha + 4, coluna + 1),
                        Pair(linha + 3, coluna-1), Pair(linha + 3, coluna + 1), Pair(linha + 2, coluna-1), Pair(linha + 2, coluna + 1), Pair(linha + 1, coluna-1),
                        Pair(linha + 1, coluna + 1), Pair(linha, coluna-1), Pair(linha, coluna+1), Pair(linha - 1, coluna - 1), Pair(linha - 1, coluna), Pair(linha - 1, coluna + 1)))}
                "E"->{coordenadas = juntarCoordenadas(coordenadas, arrayOf(Pair(linha - 1, coluna-1), Pair(linha - 1, coluna), Pair(linha - 1, coluna + 1),
                        Pair(linha - 1, coluna + 2), Pair(linha - 1, coluna + 3), Pair(linha - 1, coluna + 4), Pair(linha, coluna-1), Pair(linha, coluna + 4),
                        Pair(linha + 1, coluna-1), Pair(linha + 1, coluna), Pair(linha + 1, coluna + 1), Pair(linha + 1, coluna + 2), Pair(linha + 1, coluna + 3), Pair(linha + 1, coluna + 4)))}
                "O"->{coordenadas = juntarCoordenadas(coordenadas, arrayOf(Pair(linha - 1, coluna+1), Pair(linha - 1, coluna), Pair(linha - 1, coluna - 1),
                        Pair(linha - 1, coluna - 2), Pair(linha - 1, coluna - 3), Pair(linha - 1, coluna - 4), Pair(linha, coluna+1), Pair(linha, coluna - 4),
                        Pair(linha + 1, coluna+1), Pair(linha + 1, coluna), Pair(linha + 1, coluna - 1), Pair(linha + 1, coluna - 2), Pair(linha + 1, coluna - 3), Pair(linha + 1, coluna - 4)))}
            }
